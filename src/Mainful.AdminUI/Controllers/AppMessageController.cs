...
namespace Mainful.AdminUI.Controllers
{
    public class AppMessageController : BaseController
    {
        ...
        {
            AppMessageBL appmessageBL = new AppMessageBL();
            JsonResultEntity response = new JsonResultEntity();

            try
            {
                var result = appmessageBL.GetAll(dbParamEntity);
                ...
                var dataFound = appmessageBL.GetTotalRows(dbParamEntity);
		...
		public JsonResultEntity GetById(int id)
        {
            ...
            try
            {
                var result = appmessageBL.GetById(id);
        ...
        [HttpPost]
		public JsonResultEntity Create([FromBody] AppMessageEntity appmessageEntity)
        {
            AppMessageBL appmessageBL = new AppMessageBL();
            JsonResultEntity response = new JsonResultEntity();
            ...
            try
            {
                var result = appmessageBL.Create(appmessageEntity);
        ...
        [HttpPost]
        public JsonResultEntity Update([FromBody] AppMessageEntity appmessageEntity)
        {
            AppMessageBL appmessageBL = new AppMessageBL();
            JsonResultEntity response = new JsonResultEntity();
            try
            {
                var result = appmessageBL.Update(appmessageEntity);
        ...
        {
            var appmessageBL = new AppMessageBL();
            JsonResultEntity response = new JsonResultEntity();
            try
            {
                var result = appmessageBL.DeleteById(id);
                if (result.HasWarning())
                {
                    response.Message = String.Join(",", result.Warning);
                    return response;
