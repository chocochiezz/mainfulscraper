...
namespace Mainful.AdminUI.Controllers
{
    public class UserFavoriteController : BaseController
    {
        ...
        public override JsonResultEntity Get([FromBody] DBParamEntity dbParamEntity)
        {
            ...
            try
            {
                var result = userfavoriteBL.GetAll(dbParamEntity);
                ...
                var dataFound = userfavoriteBL.GetTotalRows(dbParamEntity);
		...
		public JsonResultEntity GetById(int id)
        {
            ...
            try
            {
                var result = userfavoriteBL.GetById(id);
        ...
        [HttpPost]
        public JsonResultEntity Update([FromBody] UserFavoriteEntity userfavoriteEntity)
        {
            UserFavoriteBL userfavoriteBL = new UserFavoriteBL();
            JsonResultEntity response = new JsonResultEntity();
            try
            {
                var result = userfavoriteBL.Update(userfavoriteEntity);
