...
{
    public class EventOrganizerController : BaseController
    {
		[HttpPost]
        public override JsonResultEntity Get([FromBody] DBParamEntity dbParamEntity)
        {
            ...
            try
            {
                var result = eventorganizerBL.GetAll(dbParamEntity);
                ...
                var dataFound = eventorganizerBL.GetTotalRows(dbParamEntity);
		...
		public JsonResultEntity GetById(int id)
        {
            ...
            try
            {
                var result = eventorganizerBL.GetById(id);
        ...
        {
            var eventorganizerBL = new EventOrganizerBL();
            JsonResultEntity response = new JsonResultEntity();
            try
            {
                var result = eventorganizerBL.DeleteById(id);
                if (result.HasWarning())
                {
                    response.Message = String.Join(",", result.Warning);
                    return response;
