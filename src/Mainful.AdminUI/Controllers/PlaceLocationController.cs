...
{
    public class PlaceLocationController : BaseController
    {
		[HttpPost]
		...
		public JsonResultEntity GetById(int id)
        {
            ...
            try
            {
                var result = placelocationBL.GetById(id);
        ...
        [HttpPost]
        public JsonResultEntity Update([FromBody] PlaceLocationEntity placelocationEntity)
        {
            PlaceLocationBL placelocationBL = new PlaceLocationBL();
            JsonResultEntity response = new JsonResultEntity();
            ...
            try
            {
                var result = placelocationBL.Update(placelocationEntity);
