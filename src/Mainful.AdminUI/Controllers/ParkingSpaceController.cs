...
namespace Mainful.AdminUI.Controllers
{
    public class ParkingSpaceController : BaseController
    {
        ...
        public override JsonResultEntity Get([FromBody] DBParamEntity dbParamEntity)
        {
            ...
            try
            {
                var result = parkingspaceBL.GetAll(dbParamEntity);
                ...
                var dataFound = parkingspaceBL.GetTotalRows(dbParamEntity);
		...
		public JsonResultEntity GetById(int id)
        {
            ...
            try
            {
                var result = parkingspaceBL.GetById(id);
        ...
        [HttpPost]
        public JsonResultEntity Update([FromBody] ParkingSpaceEntity parkingspaceEntity)
        {
            ParkingSpaceBL parkingspaceBL = new ParkingSpaceBL();
            JsonResultEntity response = new JsonResultEntity();
            try
            {
                var result = parkingspaceBL.Update(parkingspaceEntity);
        ...
        {
            var parkingspaceBL = new ParkingSpaceBL();
            JsonResultEntity response = new JsonResultEntity();
            try
            {
                var result = parkingspaceBL.DeleteById(id);
                if (result.HasWarning())
                {
                    response.Message = String.Join(",", result.Warning);
                    return response;
