...
Ext.define('MyApp.view.userProfile.UserProfileController', {
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('userProfileStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserProfile/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserProfile/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'UserProfile/ExportToExcel',
