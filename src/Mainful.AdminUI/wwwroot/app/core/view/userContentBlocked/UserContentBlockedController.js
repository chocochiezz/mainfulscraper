...
Ext.define('MyApp.view.userContentBlocked.UserContentBlockedController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.userContentBlocked',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('userContentBlockedStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserContentBlocked/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserContentBlocked/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'UserContentBlocked/ExportToExcel',
