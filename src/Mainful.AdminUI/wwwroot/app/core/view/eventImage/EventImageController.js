...
Ext.define('MyApp.view.eventImage.EventImageController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.eventImage',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('eventImageStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventImage/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventImage/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'EventImage/ExportToExcel',
