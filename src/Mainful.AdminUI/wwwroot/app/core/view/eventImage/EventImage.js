...
Ext.define('MyApp.view.eventImage.EventImage', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyEventImage',
    requires: [
        'MyApp.view.eventImage.EventImageController',
        'MyApp.store.EventImageStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('eventImageStore'),
        columns: MyApp.GlobalFunc.getGridColumns('eventImageStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('eventImageStore')
            },
        ],
