...
Ext.define('MyApp.view.placeLocationImage.PlaceLocationImageController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.placeLocationImage',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('placeLocationImageStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceLocationImage/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceLocationImage/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PlaceLocationImage/ExportToExcel',
