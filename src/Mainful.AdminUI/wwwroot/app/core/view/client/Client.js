...
Ext.define('MyApp.view.client.Client', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyClient',
    requires: [
        'MyApp.view.client.ClientController',
        'MyApp.store.ClientStore'
    ],
    controller: 'client',
	border: false,
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('clientStore'),
        columns: MyApp.GlobalFunc.getGridColumns('clientStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
