...
Ext.define('MyApp.view.parkingSpaceRent.ParkingSpaceRentController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.parkingSpaceRent',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('parkingSpaceRentStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ParkingSpaceRent/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ParkingSpaceRent/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'ParkingSpaceRent/ExportToExcel',
