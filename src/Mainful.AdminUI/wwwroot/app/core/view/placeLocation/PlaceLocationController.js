...
Ext.define('MyApp.view.placeLocation.PlaceLocationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.placeLocation',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('placeLocationStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceLocation/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceLocation/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PlaceLocation/ExportToExcel',
