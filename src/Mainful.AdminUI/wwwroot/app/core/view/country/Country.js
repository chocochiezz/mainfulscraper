...
Ext.define('MyApp.view.country.Country', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyCountry',
    requires: [
        'MyApp.view.country.CountryController',
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('countryStore'),
        columns: MyApp.GlobalFunc.getGridColumns('countryStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
