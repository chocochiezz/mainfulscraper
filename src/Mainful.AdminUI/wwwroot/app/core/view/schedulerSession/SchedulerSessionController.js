...
Ext.define('MyApp.view.schedulerSession.SchedulerSessionController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.schedulerSession',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('schedulerSessionStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'SchedulerSession/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'SchedulerSession/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'SchedulerSession/ExportToExcel',
