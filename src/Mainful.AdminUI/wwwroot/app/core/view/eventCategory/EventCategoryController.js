...
Ext.define('MyApp.view.eventCategory.EventCategoryController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.eventCategory',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('eventCategoryStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventCategory/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventCategory/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'EventCategory/ExportToExcel',
