...
Ext.define('MyApp.view.eventCategory.EventCategory', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyEventCategory',
    requires: [
        'MyApp.view.eventCategory.EventCategoryController',
        'MyApp.store.EventCategoryStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('eventCategoryStore'),
        columns: MyApp.GlobalFunc.getGridColumns('eventCategoryStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('eventCategoryStore')
            },
        ],
