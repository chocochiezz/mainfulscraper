...
Ext.define('MyApp.view.tracking.TrackingController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.tracking',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('trackingStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'Tracking/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'Tracking/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'Tracking/ExportToExcel',
