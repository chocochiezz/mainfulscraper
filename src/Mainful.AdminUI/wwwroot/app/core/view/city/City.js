...
Ext.define('MyApp.view.city.City', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyCity',
    requires: [
        'MyApp.view.city.CityController',
        'MyApp.store.CityStore'
    ],
    controller: 'city',
	border: false,
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('cityStore'),
        columns: MyApp.GlobalFunc.getGridColumns('cityStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
