...
Ext.define('MyApp.view.eventOrganizer.EventOrganizerController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.eventOrganizer',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('eventOrganizerStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventOrganizer/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventOrganizer/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'EventOrganizer/ExportToExcel',
