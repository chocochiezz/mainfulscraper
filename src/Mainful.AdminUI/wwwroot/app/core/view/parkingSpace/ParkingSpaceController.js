...
Ext.define('MyApp.view.parkingSpace.ParkingSpaceController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.parkingSpace',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('parkingSpaceStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ParkingSpace/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ParkingSpace/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'ParkingSpace/ExportToExcel',
