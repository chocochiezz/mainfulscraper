...
Ext.define('MyApp.view.parkingSpace.ParkingSpace', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyParkingSpace',
    requires: [
        'MyApp.view.parkingSpace.ParkingSpaceController',
        'MyApp.store.ParkingSpaceStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('parkingSpaceStore'),
        columns: MyApp.GlobalFunc.getGridColumns('parkingSpaceStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('parkingSpaceStore')
            },
        ],
