...
Ext.define('MyApp.view.promoPlaceLocation.PromoPlaceLocationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.promoPlaceLocation',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('promoPlaceLocationStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PromoPlaceLocation/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PromoPlaceLocation/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PromoPlaceLocation/ExportToExcel',
