...
Ext.define('MyApp.view.groupAdministrator.GroupAdministratorController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.groupAdministrator',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('groupAdministratorStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'GroupAdministrator/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'GroupAdministrator/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'GroupAdministrator/ExportToExcel',
