...
Ext.define('MyApp.view.userFavorite.UserFavorite', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyUserFavorite',
    requires: [
        'MyApp.view.userFavorite.UserFavoriteController',
        'MyApp.store.UserFavoriteStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('userFavoriteStore'),
        columns: MyApp.GlobalFunc.getGridColumns('userFavoriteStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('userFavoriteStore')
            },
        ],
