...
Ext.define('MyApp.view.userFavorite.UserFavoriteController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.userFavorite',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('userFavoriteStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserFavorite/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserFavorite/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'UserFavorite/ExportToExcel',
