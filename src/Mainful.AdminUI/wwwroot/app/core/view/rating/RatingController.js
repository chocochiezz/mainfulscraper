...
Ext.define('MyApp.view.rating.RatingController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.rating',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('ratingStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'Rating/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'Rating/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'Rating/ExportToExcel',
