...
Ext.define('MyApp.view.rating.Rating', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyRating',
    requires: [
        'MyApp.view.rating.RatingController',
        'MyApp.store.RatingStore'
    ],
    controller: 'rating',
	border: false,
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('ratingStore'),
        columns: MyApp.GlobalFunc.getGridColumns('ratingStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('ratingStore')
            },
        ],
