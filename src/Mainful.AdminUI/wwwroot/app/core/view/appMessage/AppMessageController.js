...
Ext.define('MyApp.view.appMessage.AppMessageController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.appMessage',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('appMessageStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'AppMessage/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'AppMessage/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'AppMessage/ExportToExcel',
