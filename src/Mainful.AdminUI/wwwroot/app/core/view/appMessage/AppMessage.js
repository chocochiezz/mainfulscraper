...
Ext.define('MyApp.view.appMessage.AppMessage', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyAppMessage',
    requires: [
        'MyApp.view.appMessage.AppMessageController',
        'MyApp.store.AppMessageStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('appMessageStore'),
        columns: MyApp.GlobalFunc.getGridColumns('appMessageStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('appMessageStore')
            },
        ],
