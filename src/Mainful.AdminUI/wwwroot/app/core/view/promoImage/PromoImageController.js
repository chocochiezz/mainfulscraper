...
Ext.define('MyApp.view.promoImage.PromoImageController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.promoImage',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('promoImageStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PromoImage/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PromoImage/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PromoImage/ExportToExcel',
