...
Ext.define('MyApp.view.promoImage.PromoImage', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyPromoImage',
    requires: [
        'MyApp.view.promoImage.PromoImageController',
        'MyApp.store.PromoImageStore'
    ],
    controller: 'promoImage',
	border: false,
    items: [{
        region: 'center',
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('promoImageStore'),
        columns: MyApp.GlobalFunc.getGridColumns('promoImageStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('promoImageStore')
            },
        ],
