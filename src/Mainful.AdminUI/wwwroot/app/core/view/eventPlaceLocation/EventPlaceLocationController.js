...
Ext.define('MyApp.view.eventPlaceLocation.EventPlaceLocationController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.eventPlaceLocation',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('eventPlaceLocationStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventPlaceLocation/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'EventPlaceLocation/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'EventPlaceLocation/ExportToExcel',
