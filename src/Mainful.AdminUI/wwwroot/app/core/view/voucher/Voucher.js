...
Ext.define('MyApp.view.voucher.Voucher', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyVoucher',
    requires: [
        'MyApp.view.voucher.VoucherController',
        'MyApp.store.VoucherStore'
    ],
    controller: 'voucher',
	border: false,
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('voucherStore'),
        columns: MyApp.GlobalFunc.getGridColumns('voucherStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('voucherStore')
            },
        ],
