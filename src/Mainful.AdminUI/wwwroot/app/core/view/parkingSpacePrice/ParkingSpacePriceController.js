...
Ext.define('MyApp.view.parkingSpacePrice.ParkingSpacePriceController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.parkingSpacePrice',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('parkingSpacePriceStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ParkingSpacePrice/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ParkingSpacePrice/Update';
    ...
    onBtnSaveClick: function () {
        ...
        if (form.isValid()) {
            ...
            if (form.findField('ParkingSpaceID').value.length > 0)
                form.findField('ParkingSpaceID').value = form.findField('ParkingSpaceID').value[0];
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'ParkingSpacePrice/ExportToExcel',
