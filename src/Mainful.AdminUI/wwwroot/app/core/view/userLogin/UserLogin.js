...
Ext.define('MyApp.view.userLogin.UserLogin', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyUserLogin',
    requires: [
        'MyApp.view.userLogin.UserLoginController',
        'MyApp.store.UserLoginStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('userLoginStore'),
        columns: MyApp.GlobalFunc.getGridColumns('userLoginStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('userLoginStore')
            },
        ],
