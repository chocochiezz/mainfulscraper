...
Ext.define('MyApp.view.placeSubCategory.PlaceSubCategoryController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.placeSubCategory',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('placeSubCategoryStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceSubCategory/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceSubCategory/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PlaceSubCategory/ExportToExcel',
