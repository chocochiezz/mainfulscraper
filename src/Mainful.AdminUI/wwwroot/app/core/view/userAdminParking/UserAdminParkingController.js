...
Ext.define('MyApp.view.userAdminParking.UserAdminParkingController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.userAdminParking',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('userAdminParkingStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserAdminParking/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserAdminParking/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'UserAdminParking/ExportToExcel',
