...
Ext.define('MyApp.view.placeUserImage.PlaceUserImageController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.placeUserImage',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('placeUserImageStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceUserImage/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceUserImage/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PlaceUserImage/ExportToExcel',
