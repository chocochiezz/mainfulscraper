...
Ext.define('MyApp.view.reportContent.ReportContent', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyReportContent',
    requires: [
        'MyApp.view.reportContent.ReportContentController',
        'MyApp.store.ReportContentStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('reportContentStore'),
        columns: MyApp.GlobalFunc.getGridColumns('reportContentStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('reportContentStore')
            },
        ],
