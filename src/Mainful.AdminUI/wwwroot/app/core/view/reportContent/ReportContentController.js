...
Ext.define('MyApp.view.reportContent.ReportContentController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.reportContent',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('reportContentStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ReportContent/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'ReportContent/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'ReportContent/ExportToExcel',
