...
Ext.define('MyApp.view.promoCategory.PromoCategoryController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.promoCategory',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('promoCategoryStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PromoCategory/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PromoCategory/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PromoCategory/ExportToExcel',
