...
Ext.define('MyApp.view.placeCategory.PlaceCategoryController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.placeCategory',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('placeCategoryStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceCategory/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'PlaceCategory/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'PlaceCategory/ExportToExcel',
