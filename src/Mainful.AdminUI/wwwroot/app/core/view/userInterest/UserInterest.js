...
Ext.define('MyApp.view.userInterest.UserInterest', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyUserInterest',
    requires: [
        'MyApp.view.userInterest.UserInterestController',
        'MyApp.store.UserInterestStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('userInterestStore'),
        columns: MyApp.GlobalFunc.getGridColumns('userInterestStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
        ...
        bbar: [
            {
				...
				flex: 1,
				border: false,
                store: Ext.data.StoreManager.lookup('userInterestStore')
            },
        ],
