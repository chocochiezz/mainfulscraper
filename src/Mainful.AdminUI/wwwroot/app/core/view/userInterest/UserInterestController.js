...
Ext.define('MyApp.view.userInterest.UserInterestController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.userInterest',
    ...
    init: function () {
        ...
        if (formPanel) {
            formPanel.removeAll();
            formPanel.add(MyApp.GlobalFunc.generateFormFields('userInterestStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserInterest/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserInterest/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'UserInterest/ExportToExcel',
