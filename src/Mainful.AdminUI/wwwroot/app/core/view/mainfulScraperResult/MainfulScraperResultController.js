...
Ext.define('MyApp.view.mainfulScraperResult.MainfulScraperResultController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.mainfulScraperResult',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('promoStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'Promo/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'Promo/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'Promo/ExportToExcel',
