...
Ext.define('MyApp.view.mainfulScraperResult.MainfulScraperResult', {
    extend: 'Ext.panel.Panel',
    xtype: 'MainfulScraperResult',
    requires: [
        'MyApp.view.mainfulScraperResult.MainfulScraperResultController',
        'MyApp.store.MainfulScraperResultStore'
    ],
    controller: 'mainfulScraperResult',
    border: false,
    items: [{
        region: 'center',
        xtype: 'gridpanel',
