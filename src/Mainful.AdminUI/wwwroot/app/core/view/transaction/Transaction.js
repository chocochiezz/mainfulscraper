...
Ext.define('MyApp.view.transaction.Transaction', {
    extend: 'Ext.panel.Panel',
    xtype: 'MyTransaction',
    requires: [
        'MyApp.view.transaction.TransactionController',
        'MyApp.store.TransactionStore'
    ],
    ...
    items: [{
        ...
        xtype: 'gridpanel',
        reference: 'myGrid',
        store: MyApp.GlobalFunc.storeFactory('transactionStore'),
        columns: MyApp.GlobalFunc.getGridColumns('transactionStore', true),
        selType: 'rowmodel',
        plugins: 'gridfilters',
        stateful: true,
		border: false,
