...
Ext.define('MyApp.view.userAdministrator.UserAdministratorController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.userAdministrator',
    ...
    init: function () {
        ...
        if (formPanel) {
            //formPanel.removeAll();
            //formPanel.add(MyApp.GlobalFunc.generateFormFields('userAdministratorStore'));
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserAdministrator/Create';
    ...
    onSelectionChange: function (selectionModel, selected, eOpts) {
        ...
        if (formPanel !== null) {
            ...
            formPanel.url = MyApp.GlobalVar.BASE_API_URL + 'UserAdministrator/Update';
	...
	onExportClick: function () {
		...
		Ext.Ajax.request({
			method: 'POST',
			url: MyApp.GlobalVar.BASE_API_URL + 'UserAdministrator/ExportToExcel',
