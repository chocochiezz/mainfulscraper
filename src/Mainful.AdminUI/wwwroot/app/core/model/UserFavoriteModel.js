...
Ext.define('MyApp.model.UserFavoriteModel', {
    ...
    proxy: {
        ...
        api: {
            create: MyApp.GlobalVar.BASE_API_URL + 'UserFavorite/Create',
            read: MyApp.GlobalVar.BASE_API_URL + 'UserFavorite/Get',
            update: MyApp.GlobalVar.BASE_API_URL + 'UserFavorite/Update',
            destroy: MyApp.GlobalVar.BASE_API_URL + 'UserFavorite/Delete',
        },
        reader: {
            type: 'json',
            rootProperty: 'Data',
