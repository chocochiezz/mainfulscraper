...
Ext.define('MyApp.model.PromoCategoryModel', {
    ...
    proxy: {
        ...
        api: {
            create: MyApp.GlobalVar.BASE_API_URL + 'PromoCategory/Create',
            read: MyApp.GlobalVar.BASE_API_URL + 'PromoCategory/Get',
            update: MyApp.GlobalVar.BASE_API_URL + 'PromoCategory/Update',
            destroy: MyApp.GlobalVar.BASE_API_URL + 'PromoCategory/Delete',
        },
        reader: {
            type: 'json',
            rootProperty: 'Data',
