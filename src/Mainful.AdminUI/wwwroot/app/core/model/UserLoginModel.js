...
Ext.define('MyApp.model.UserLoginModel', {
    extend: 'MyApp.model.BaseModel',
    idProperty: 'ID',
    fields: [
		{ name: 'ID', convert: null, type: 'int' },
		{ name: 'LoginProvider', type: 'string' },
    ...
    proxy: {
        ...
        api: {
            create: MyApp.GlobalVar.BASE_API_URL + 'UserLogin/Create',
            read: MyApp.GlobalVar.BASE_API_URL + 'UserLogin/Get',
            update: MyApp.GlobalVar.BASE_API_URL + 'UserLogin/Update',
            destroy: MyApp.GlobalVar.BASE_API_URL + 'UserLogin/Delete',
        },
        reader: {
            type: 'json',
            rootProperty: 'Data',
