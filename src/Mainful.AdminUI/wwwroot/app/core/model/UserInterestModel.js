...
Ext.define('MyApp.model.UserInterestModel', {
    ...
    proxy: {
        ...
        api: {
            create: MyApp.GlobalVar.BASE_API_URL + 'UserInterest/Create',
            read: MyApp.GlobalVar.BASE_API_URL + 'UserInterest/Get',
            update: MyApp.GlobalVar.BASE_API_URL + 'UserInterest/Update',
            destroy: MyApp.GlobalVar.BASE_API_URL + 'UserInterest/Delete',
        },
        reader: {
            type: 'json',
            rootProperty: 'Data',
